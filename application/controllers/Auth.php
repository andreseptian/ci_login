...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = [
                ...
                'callName' => htmlspecialchars($this->input->post('callName', true)),
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'cilogin2020@gmail.com',
            'smtp_pass' => 'tanpanama02',
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ...
        $this->email->from('cilogin2020@gmail.com', 'CI Login 2020');
    ...
    public function verify()
    {
        ...
        if ($user) {
            ...
            if ($user_token) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Account activation failed! Token expired, register again.</div>');
                redirect('auth');
            }
        } else {
